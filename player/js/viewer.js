  ...
  let streamName = document.getElementById("id").value;
  let subToken = document.getElementById("token").value;// SubscribingToken - placed here for ease of testing, should come from secure location. (php/nodejs)
 


  console.log('Millicast Viewer Stream Data : ', streamName, accountId, subToken);
  ...
  function ready() {
    ...
    //connect();
    // get a list of  ice servers.  //Twil
    getICEServers()
      .then(list => {
        iceServers = list;
        //ready to connect.
